...
const signData = (data, privateKey) => {
    return prsUtility.signBlockData(data, privateKey);
};
...
(async () => {
    try {
        ...
        console.log(buildBlock(f, 'EOS7ZtBTNsekNJWJHMieEeELQWPpVwbKs7ezVE9nKk9rpkJ69wxUR', '5Jyqyqzx1FPzU6EqtmG4vLUABTuNR6P59eeSBW6an2rStuEgj77', { private: true }));
