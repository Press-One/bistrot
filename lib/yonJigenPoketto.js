...
const provideStorage = async (
    ...
    const data = {
        ...
        ipfs_signature: await ipfsSign(peerId._privKey, transactionId), // 可能需要改为签其他字段
        request: transactionId,
        ipfs_peer_id: peerId.toB58String(),
        ipfs_peer_publickey: utility.base64Encode(peerId._pubKey.bytes, true),
        user_account: publicKey, // respTrx.data.ueser, // 这个是request的用户么？
...
(async () => {
    try {
        ...
        // new promise: bd728b63ba46a01d4060bf99dc86e1059bb933d00adc3041ed9c5c2d139aed57
