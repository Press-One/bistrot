...
const assetIds = {
    ...
    CNB: {
        ...
        rumAddress: '0x0782A54Ef424e6ab296D294130803292eB22Bc0f',
    },
    COB: {
...
const getRfcUrlNamespaceUuid = () =>
    uoid.getRfcUrlNamespaceUuid(officialUrlNamespace);
...
const getAssetByNameOrId = (id, options) => {
    ...
    if (resp) {
        ...
        resp.rumAddress && (resp.rumSymbol = `R${resp.symbolDisplay}`);
        if (!options.noChain) {
