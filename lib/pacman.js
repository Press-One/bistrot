...
const packAct = (action, transaction, block) => {
    ...
    const act = {
        [`${keyTrx}_id`]: transaction?.trx?.id || '*',
        [`${keyTrx}_transaction_actions_account`]: action.account,
        [`${keyTrx}_transaction_actions_data__amount_quantity__amt`]: l?.[2],
        [`${keyTrx}_transaction_actions_data__amount_quantity__cur`]: l?.[1],
        [`${keyTrx}_transaction_actions_data__dp_wd_req__id`]: t,
        [`${keyTrx}_transaction_actions_data__from_user`]: q,
        [`${keyTrx}_transaction_actions_data__sync_auth__result`]: m,
        [`${keyTrx}_transaction_actions_data__to_user`]: r,
        [`${keyTrx}_transaction_actions_data_data_allow`]: p?.allow,
        [`${keyTrx}_transaction_actions_data_data_bill_id`]: p?.bill_id,
        [`${keyTrx}_transaction_actions_data_data_content_id`]: p?.content_id,
        [`${keyTrx}_transaction_actions_data_data_deny`]: p?.deny,
        [`${keyTrx}_transaction_actions_data_data_file_hash`]: p?.file_hash,
        [`${keyTrx}_transaction_actions_data_data_file_hash`]: p?.file_hash,
        [`${keyTrx}_transaction_actions_data_data_profile_provider`]: u,
        [`${keyTrx}_transaction_actions_data_data_topic`]: p?.topic,
        [`${keyTrx}_transaction_actions_data_data_wrapping_id`]: p?.wrapping_id,
        [`${keyTrx}_transaction_actions_data_data`]: p,
        [`${keyTrx}_transaction_actions_data_id`]: k?.id?.toUpperCase?.(),
        [`${keyTrx}_transaction_actions_data_meta_mime`]: s?.mime,
        [`${keyTrx}_transaction_actions_data_meta_uris`]: v,
        [`${keyTrx}_transaction_actions_data_meta`]: s,
        [`${keyTrx}_transaction_actions_data_mixin_trace_id`]: w,
        [`${keyTrx}_transaction_actions_data_oracleservice`]: x,
        [`${keyTrx}_transaction_actions_data_type`]: k?.type || n?.type,
        [`${keyTrx}_transaction_actions_data_user_address`]: k?.user_address,
        [`${keyTrx}_transaction_actions_name`]: action.name,
