...
const { utilitas, event, defi, sushibar } = require('sushitrain');
...
const queryPricesHistory = async (currency, period) => {
    ...
    return await sushibar.requestApi('GET', `defi/prices/${currency}/${period}`,
        null, null, 'Error querying price data.');
};
