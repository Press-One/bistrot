...
const getAccount = async (acc) => {
    ...
    return Object.assign(accResp, {
        ...
        bound_mixin_profile: utilitas.extract(accBound, 'bound_profile'),
    });
};
...
const accountEvolution = async (
    ...
    prsc.assertString(userAddress, 'Invalid legacy user address.');
    ...
    const postData = {
        ...
        legacySignature: prsUtility.signBlockData(data, previousPrivateKey),
    };
