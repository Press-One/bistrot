...
const delegateBw = async (
    chainAccount, receiver, cpuQuantity, netQuantity, privateKey, options
) => {
    assert(verifyAccountName(receiver), 'Invalid publicKey key.');
    [
        {
            "data": {
                "from": "test.bp1",
                "receiver": "test.bp1",
                "transfer": false,
                "stake_cpu_quantity": "1.0000 SRP",
                "stake_net_quantity": "1.0000 SRP"
            },
            "name": "delegatebw",
            "account": "eosio",
            "hex_data": "000000a11e90b1ca000000a11e90b1ca102700000000000004535250000000001027000000000000045352500000000000",
            "authorization": [
                {
                    "actor": "test.bp1",
                    "permission": "active"
    ...
    [
        {
            "data": {
                "from": "test.bp1",
                "receiver": "test.bp1",
                "unstake_cpu_quantity": "1.0000 SRP",
                "unstake_net_quantity": "1.0000 SRP"
            },
            "name": "undelegatebw",
            "account": "eosio",
            "hex_data": "000000a11e90b1ca000000a11e90b1ca1027000000000000045352500000000010270000000000000453525000000000",
            "authorization": [
                {
                    "actor": "test.bp1",
                    "permission": "active"
...
const deposit = async (privateKey, account, email, amount, memo, options) => {
    ...
    result.paymentTimeout = new Date(
        new Date().getTime() + 1000 * 60 * paymentTimeout
    ).toISOString();
    return result;
};
