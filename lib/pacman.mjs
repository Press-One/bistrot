...
class PACMAN {
    _cdata; _declaration; _text; classBlack; classTranx; cy_tenantid; inteval; keys; rules; uriRoot;
    curId = 0; current = 0; verifiedId = 0; verifyDelay = 0; silent = false; xmlJson = false; mvm = false;
    callbacks = {
    ...
    key = key; rule = rule; valuePack = valuePack; valueUnpack = valueUnpack;
