...
const adjustAllowance = (contractAddress, mthd, spender, am, key, op) =>
    sendToPreparedMethod(contractAddress, mthd, [
        assertSpender(spender), assertAmount(am),
    ], key, op);

const approve = (contractAddress, spender, amount, key, op) =>
    adjustAllowance(contractAddress, 'approve', spender, amount, key, op);
...
const transferFrom = (contractAddress, sender, recipient, amount, op) =>
